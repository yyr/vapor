...
The command...
    ...
    vdfcp -vars P:T -level 2 -ts0 10 -numts 20 path/to/source.vdf path/to/data
...
This command...
    ...
    tar -cf foo.tar 'vdfcp -list -ts1 50 -numts 20 path/to/source.vdf'
...
This command...
    ...
    vdfcp -info -nvars bx:bz ts1 30 path/to/source.vdf
