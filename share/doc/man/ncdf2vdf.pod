...
This option is required.  Specify the name of the variable in the VDC 
...
This option is required.  Specify a colon-separated list of the dimension names in the NetCDF file that will be converted to X, Y, and Z dimensions in the VDC.  If the variable is 2D, the Z dimension name is ignored.  The Y dimension
...
This option is required if there are more dimensions associated with the NetCDF variable than the 2 or 3 dimensions of the variable in the VDC. In a colon-separated list, specify one or more dimension names in the NetCDF file that are held constant for this time step of the variable.  Typically time is a constant dimension name.
