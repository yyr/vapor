...
static const char qt_meta_stringdata_CommandLine[] = {
    "CommandLine\0\0on_buttonBox_accepted()\0"
};
...
const QMetaObject CommandLine::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CommandLine,
...
void *CommandLine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_CommandLine"))
        return static_cast< Ui_CommandLine*>(const_cast< CommandLine*>(this));
    return QDialog::qt_metacast(_clname);
}
