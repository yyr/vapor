...
public:
    ...
    void setupUi(QWizardPage *Page3)
    {
        ...
        label_40->setGeometry(QRect(20, 72, 211, 21));
        QFont font1;
        ...
        numtsSpinner->setGeometry(QRect(367, 95, 91, 25));
        ...
        vdfCommentButton->setGeometry(QRect(307, 332, 147, 23));
        ...
        showCommandButton = new QPushButton(Page3);
        showCommandButton->setObjectName(QString::fromUtf8("showCommandButton"));
        showCommandButton->setGeometry(QRect(162, 332, 147, 23));
        processIndicator = new QLabel(Page3);
        processIndicator->setObjectName(QString::fromUtf8("processIndicator"));
        processIndicator->setGeometry(QRect(310, 30, 141, 41));
    ...
    void retranslateUi(QWizardPage *Page3)
    {
        ...
        advanceOptionButton->setText(QApplication::translate("Page3", " Advanced", 0, QApplication::UnicodeUTF8));
        ...
        clearAllButton->setText(QApplication::translate("Page3", "Clear", 0, QApplication::UnicodeUTF8));
        vdfCommentButton->setText(QApplication::translate("Page3", "Add Comment", 0, QApplication::UnicodeUTF8));
        createVdfLabel->setText(QString());
        showCommandButton->setText(QApplication::translate("Page3", "Show Command", 0, QApplication::UnicodeUTF8));
        processIndicator->setText(QApplication::translate("Page3", "Analyzing Files...", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
