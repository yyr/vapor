...
public:
    ...
    void setupUi(QDialog *Page2badfile)
    {
        ...
        Page2badfile->resize(351, 225);
        buttonBox = new QDialogButtonBox(Page2badfile);
        buttonBox->setObjectName(QString::fromUtf8("buttonBox"));
        buttonBox->setGeometry(QRect(93, 170, 161, 31));
        buttonBox->setOrientation(Qt::Horizontal);
        buttonBox->setStandardButtons(QDialogButtonBox::Cancel|QDialogButtonBox::Ok);
        label = new QLabel(Page2badfile);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(100, 20, 141, 20));
        label->setAlignment(Qt::AlignCenter);
        label_2 = new QLabel(Page2badfile);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(40, 50, 271, 111));
        label_2->setWordWrap(true);
        exitButton = new QPushButton(Page2badfile);
        exitButton->setObjectName(QString::fromUtf8("exitButton"));
        exitButton->setGeometry(QRect(175, 170, 121, 32));
        continueButton = new QPushButton(Page2badfile);
        continueButton->setObjectName(QString::fromUtf8("continueButton"));
        continueButton->setEnabled(true);
        continueButton->setGeometry(QRect(50, 170, 121, 32));
    ...
    void retranslateUi(QDialog *Page2badfile)
    {
        ...
        label_2->setText(QApplication::translate("Page2badfile", "The file you've selected does not have the standard .vdf file extension.  This will be automatically corrected.", 0, QApplication::UnicodeUTF8));
        exitButton->setText(QApplication::translate("Page2badfile", "Exit", 0, QApplication::UnicodeUTF8));
        continueButton->setText(QApplication::translate("Page2badfile", "Continue", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
