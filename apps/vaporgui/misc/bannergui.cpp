...
VAPoR::BannerGUI::BannerGUI(std::string imagefile, int maxwait, bool center, QString text, QString url)
{
    this->url = url;
...
void VAPoR::BannerGUI::request_close()
{
    close();
}

void VAPoR::BannerGUI::on_timer_end()
{
    close();
}

void VAPoR::BannerGUI::infoButton_action()
{
    //TODO: THIS APPEARS NOT TO WORK. FIND OUT HOW OTHERS DO IT.
    QDesktopServices::openUrl(QUrl(url));
}

void VAPoR::BannerGUI::closeButton_action()
{
    close();
}
