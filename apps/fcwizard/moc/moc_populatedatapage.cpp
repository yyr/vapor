...
**
** Created: Thu Jul 25 14:52:23 2013
...
static const char qt_meta_stringdata_PopulateDataPage[] = {
    "PopulateDataPage\0\0on_goButton_clicked()\0"
    "on_advancedOptionsButton_clicked()\0"
    "on_scanVDF_clicked()\0index\0"
    "on_variableList_activated(QModelIndex)\0"
    "warnButton_clicked()\0"
};
...
void PopulateDataPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_advancedOptionsButton_clicked(); break;
        case 2: _t->on_scanVDF_clicked(); break;
        case 3: _t->on_variableList_activated((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 4: _t->warnButton_clicked(); break;
        default: ;
        }
    }
}
