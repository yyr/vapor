...
#ifndef _MetadataROMS_h_
#define _MetadataROMS_h_
...
class VDF_API MetadataROMS : public Metadata, public VetsUtil::MyBase {
public:
 MetadataROMS ();
 MetadataROMS (const vector<string> &files, const string& topofile, vector<string>& vars2d, vector<string>& vars3d);
 MetadataROMS (
