...
class SignificanceMap : public VetsUtil::MyBase {
public:
 ...
 //
 SignificanceMap(
	const unsigned char *map, size_t nx, size_t ny=1, size_t nz=1, size_t nt=1
 );
 ...
 //!
 //
 int GetCoordinatesXYZT(
	size_t i, size_t *x, size_t *y=NULL, size_t *z=NULL, size_t *t=NULL
 ) const;
...
bool inline SignificanceMap::TestXYZT(
	size_t x, size_t y, size_t z, size_t t
) const {
