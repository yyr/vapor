...
GRIBAPI_API grib_fieldset *grib_fieldset_new_from_files(grib_context *c, char *filenames[], int nfiles, char **keys, int nkeys, char *where_string, char *order_by_string, int *err);



GRIBAPI_API void grib_fieldset_delete(grib_fieldset* set);
GRIBAPI_API void grib_fieldset_rewind(grib_fieldset* set);
GRIBAPI_API int grib_fieldset_apply_order_by(grib_fieldset* set,const char* order_by_string);
GRIBAPI_API grib_handle* grib_fieldset_next_handle(grib_fieldset* set,int* err);
GRIBAPI_API int grib_fieldset_count(grib_fieldset *set);
GRIBAPI_API int grib_values_check(grib_handle* h, grib_values* values, int count);
 ...
 */
GRIBAPI_API grib_index* grib_index_new_from_file(grib_context* c,
 ...
 * @return            the newly created index
 */
GRIBAPI_API grib_index* grib_index_new(grib_context* c, const char* keys,int *err);
 ...
 */
GRIBAPI_API int grib_index_add_file(grib_index *index, const char *filename);
GRIBAPI_API int grib_index_write(grib_index *index, const char *filename);
GRIBAPI_API grib_index* grib_index_read(grib_context* c,const char* filename,int *err);
 ...
 * @return            0 if OK, integer value on error
 */
GRIBAPI_API int grib_index_get_size(grib_index* index,const char* key,size_t* size);
 ...
 * @return            0 if OK, integer value on error
 */
GRIBAPI_API int grib_index_get_long(grib_index* index,const char* key,
 ...
 * @return            0 if OK, integer value on error
 */
GRIBAPI_API int grib_index_get_double(grib_index* index,const char* key,
 ...
 * @return            0 if OK, integer value on error
 */
GRIBAPI_API int grib_index_get_string(grib_index* index,const char* key,
 ...
 * @return            0 if OK, integer value on error
 */
GRIBAPI_API int grib_index_select_long(grib_index* index,const char* key,long value);
 ...
 * @return            0 if OK, integer value on error
 */
GRIBAPI_API int grib_index_select_double(grib_index* index,const char* key,double value);
 ...
 * @return            0 if OK, integer value on error
 */
GRIBAPI_API int grib_index_select_string(grib_index* index,const char* key,char* value);
 ...
 * @return            grib handle.
 */
GRIBAPI_API grib_handle* grib_handle_new_from_index(grib_index* index,int *err);
 ...
 */
GRIBAPI_API void grib_index_delete(grib_index* index);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_count_in_file(grib_context* c, FILE* f,int* n);
...
*/
GRIBAPI_API grib_handle* grib_handle_new_from_file     (grib_context* c, FILE* f, int* error)        ;
GRIBAPI_API grib_handle* grib_handle_headers_only_new_from_file     (grib_context* c, FILE* f, int* error)        ;
...
* @return            the new handle, NULL if the resource is invalid or a problem is encountered
*/
GRIBAPI_API grib_handle* grib_handle_new_from_nc_file(grib_context* c,const char* file,int *error);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_write_message(grib_handle* h,const char* file,const char* mode);
...
GRIBAPI_API grib_handle* grib_util_sections_copy(grib_handle* hfrom,grib_handle* hto,int what,int *err);
GRIBAPI_API grib_string_list* grib_util_get_param_id(const char* mars_param);
GRIBAPI_API grib_string_list* grib_util_get_mars_param(const char* param_id);
...
*/
GRIBAPI_API grib_handle* grib_handle_new_from_message(grib_context* c, void* data, size_t data_len);
...
* @return            the new handle, NULL if the message is invalid or a problem is encountered
*/
GRIBAPI_API grib_handle* grib_handle_new_from_multi_message(grib_context* c,void** data,
...
* @return            the new handle, NULL if the message is invalid or a problem is encountered
*/
GRIBAPI_API grib_handle* grib_handle_new_from_message_copy(grib_context* c, const void* data, size_t data_len);
...
* @return            the new handle, NULL if the resource is invalid or a problem is encountered
*/
GRIBAPI_API grib_handle* grib_handle_new_from_template (grib_context* c, const char* res_name)  ;
 ...
 * @return            the new handle, NULL if the resource is invalid or a problem is encountered
 */
GRIBAPI_API grib_handle* grib_handle_new_from_samples (grib_context* c, const char* res_name)  ;
...
* @return            the new handle, NULL if the message is invalid or a problem is encountered
*/
GRIBAPI_API grib_handle* grib_handle_clone             (grib_handle* h)                 ;
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int   grib_handle_delete   (grib_handle* h);
 ...
 * @param c           : the context from which the handle will be created (NULL for default context)
 */
GRIBAPI_API grib_multi_handle* grib_multi_handle_new     (grib_context* c);
 ...
 * @return            0 if OK, integer value on error
 */
GRIBAPI_API int grib_multi_handle_append(grib_handle* h,int start_section,grib_multi_handle* mh);
 ...
 * @return            0 if OK, integer value on error
 */
GRIBAPI_API int grib_multi_handle_delete(grib_multi_handle* mh);
 ...
 * @return            0 if OK, integer value on error
 */
GRIBAPI_API int grib_multi_handle_write(grib_multi_handle* mh,FILE* f);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_get_message(grib_handle* h ,const void** message, size_t *message_length  );
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_get_message_copy(grib_handle* h ,  void* message,size_t *message_length );
/*! @} */
...
*/
GRIBAPI_API grib_iterator*      grib_iterator_new      (grib_handle*   h, unsigned long flags,int* error);
...
*/
GRIBAPI_API int                 grib_iterator_next     (grib_iterator *i, double* lat,double* lon,double* value);
...
* @return            positive value if successful, 0 if no more data are available
*/
GRIBAPI_API int                 grib_iterator_previous (grib_iterator *i, double* lat,double* lon,double* value);
...
*/
GRIBAPI_API int                 grib_iterator_has_next (grib_iterator *i);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int                 grib_iterator_reset    (grib_iterator *i);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int                 grib_iterator_delete   (grib_iterator *i);
...
*/
GRIBAPI_API grib_nearest*      grib_nearest_new      (grib_handle*   h, int* error);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_nearest_find(grib_nearest *nearest,grib_handle* h,double inlat,double inlon,
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int                 grib_nearest_delete   (grib_nearest *nearest);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_nearest_find_multiple(grib_handle* h,int is_lsm,
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int                  grib_get_offset(grib_handle* h, const char* key, size_t* offset);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int         grib_get_size(grib_handle* h, const char* key,size_t *size);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int         grib_get_length(grib_handle* h, const char* key,size_t *length);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int          grib_get_long         (grib_handle* h, const char* key, long*   value  );
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_get_double       (grib_handle* h, const char* key, double* value                             );
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_get_double_element(grib_handle* h, const char* key, int i, double* value           );
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_get_double_elements(grib_handle* h, const char* key, int* i, long size,double* value);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_get_string       (grib_handle* h, const char* key, char*   mesg,             size_t *length  );
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_get_bytes        (grib_handle* h, const char* key, unsigned char*  bytes,    size_t *length  );
/**
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_get_double_array (grib_handle* h, const char* key, double* vals,           size_t *length  );
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_get_long_array   (grib_handle* h, const char* key, long*   vals,           size_t *length  );
...
* @return          0 if OK, integer value on error
*/
GRIBAPI_API int grib_copy_namespace(grib_handle* dest, const char* name, grib_handle* src);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_set_long         (grib_handle* h, const char*  key , long val     );
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_set_double       (grib_handle* h, const char*  key , double   val   );
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_set_string       (grib_handle* h, const char*  key , const char* mesg, size_t *length );
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_set_bytes        (grib_handle* h, const char*  key, const unsigned char* bytes, size_t *length  );
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_set_double_array (grib_handle* h, const char*  key , const double*        vals   , size_t length  );

/**
* Same as grib_set_double_array but allows setting of READ-ONLY keys like codedValues.
* Use with great caution!!
*/
GRIBAPI_API int grib_set_force_double_array(grib_handle* h, const char* key, const double* vals, size_t length);
...
* @return            0 if OK, integer value on error
*/
GRIBAPI_API int grib_set_long_array   (grib_handle* h, const char*  key , const long*          vals   , size_t length  );
/*! @} */
...
*/
GRIBAPI_API void   grib_dump_content(grib_handle* h,FILE* out,const char* mode, unsigned long option_flags,void* arg);
...
*/
GRIBAPI_API void     grib_get_all_names(grib_handle* h,char* names);
...
*/
GRIBAPI_API void     grib_dump_action_tree(grib_context* c,  FILE* f) ;
...
*/
GRIBAPI_API grib_context*    grib_context_get_default(void);
...
*/
GRIBAPI_API grib_context*    grib_context_new                        (grib_context* c);
...
*/
GRIBAPI_API void             grib_context_delete                     (grib_context* c);
...
* @param c           : the context
*/
GRIBAPI_API void grib_gts_header_on(grib_context* c) ;
...
* @param c           : the context
*/
GRIBAPI_API void grib_gts_header_off(grib_context* c);
...
* @param c           : the context
*/
GRIBAPI_API void grib_gribex_mode_on(grib_context* c);
...
* @param c           : the context
*/
GRIBAPI_API int grib_get_gribex_mode ( grib_context* c);
...
* @param c           : the context
*/
GRIBAPI_API void grib_gribex_mode_off(grib_context* c);
...
*/
GRIBAPI_API void             grib_context_set_user_data              (grib_context* c, void* udata);
...
*/
GRIBAPI_API void*            grib_context_get_user_data              (grib_context* c);
...
*/
GRIBAPI_API void grib_context_set_memory_proc(grib_context* c, grib_malloc_proc griballoc,
...
* @param gribfree    : the memory freeing procedure to be set @see grib_free_proc
*/
GRIBAPI_API void  grib_context_set_persistent_memory_proc(grib_context* c, grib_malloc_proc griballoc,
  grib_free_proc gribfree);
...
* @param gribfree    : the memory freeing procedure to be set @see grib_free_proc
*/
GRIBAPI_API void  grib_context_set_buffer_memory_proc(grib_context* c, grib_malloc_proc griballoc,
       grib_free_proc gribfree,
       grib_realloc_proc gribrealloc);
...
*/
GRIBAPI_API void   grib_context_set_print_proc(grib_context* c, grib_print_proc printp);
...
*/
GRIBAPI_API void    grib_context_set_logging_proc(grib_context* c, grib_log_proc logp);
...
* @param c            : the context to be modified
*/
GRIBAPI_API void grib_multi_support_on(grib_context* c);
...
* @param c            : the context to be modified
*/
GRIBAPI_API void grib_multi_support_off(grib_context* c);
/*! @} */
...
*  @return        API version
*/
GRIBAPI_API long grib_get_api_version(void);
...
*/
GRIBAPI_API const char* grib_get_git_sha1(void);
...
*
*/
GRIBAPI_API void grib_print_api_version(FILE* out);
...
*                         and namespace
*/
GRIBAPI_API grib_keys_iterator* grib_keys_iterator_new(grib_handle* h,unsigned long filter_flags, char* name_space);
...
*/
GRIBAPI_API int grib_keys_iterator_next(grib_keys_iterator *kiter);
...
*  @return              key name
*/
GRIBAPI_API const char* grib_keys_iterator_get_name(grib_keys_iterator *kiter);

/*! Delete the iterator.
*  @param kiter         : valid grib_keys_iterator
*  @return              0 if OK, integer value on error
*/
GRIBAPI_API int grib_keys_iterator_delete( grib_keys_iterator* kiter);

/*! Rewind the iterator.
*  @param kiter         : valid grib_keys_iterator
*  @return              0 if OK, integer value on error
*/
GRIBAPI_API int grib_keys_iterator_rewind(grib_keys_iterator* kiter);


GRIBAPI_API int grib_keys_iterator_set_flags(grib_keys_iterator *kiter,unsigned long flags);
/* @} */

GRIBAPI_API void grib_update_sections_lengths(grib_handle* h);
...
*/
GRIBAPI_API const char* grib_get_error_message(int code);
GRIBAPI_API const char* grib_get_type_name(int type);

GRIBAPI_API int grib_get_native_type(grib_handle* h, const char* name,int* type);

GRIBAPI_API void grib_check(const char* call,const char*  file,int line,int e,const char* msg);
#define GRIB_CHECK(a,msg) grib_check(#a,__FILE__,__LINE__,a,msg)
#define GRIB_CHECK_NOLINE(a,msg) grib_check(#a,0,0,a,msg)


GRIBAPI_API int grib_set_values(grib_handle* h,grib_values*  grib_values , size_t arg_count);
GRIBAPI_API grib_handle* grib_handle_new_from_partial_message_copy(grib_context* c, const void* data, size_t size);
GRIBAPI_API grib_handle* grib_handle_new_from_partial_message(grib_context* c,void* data, size_t buflen);
GRIBAPI_API int grib_is_missing(grib_handle* h, const char* key, int* err);
GRIBAPI_API int grib_is_defined(grib_handle* h, const char* key);
GRIBAPI_API int grib_set_missing(grib_handle* h, const char* key);
GRIBAPI_API int grib_get_gaussian_latitudes(long truncation,double* latitudes);

GRIBAPI_API int grib_julian_to_datetime(double jd, long *year, long *month, long *day, long *hour, long *minute, long *second);
GRIBAPI_API int grib_datetime_to_julian(long year, long month, long day, long hour, long minute, long second, double *jd);
GRIBAPI_API long grib_julian_to_date(long jdate);
GRIBAPI_API long grib_date_to_julian(long ddate);

GRIBAPI_API void grib_get_reduced_row(long pl,double lon_first,double lon_last,long* npoints,long* ilon_first, long* ilon_last );

/* read products */
GRIBAPI_API int wmo_read_any_from_file(FILE *f, void *buffer, size_t *len);
GRIBAPI_API int wmo_read_grib_from_file(FILE* f,void* buffer,size_t* len);
GRIBAPI_API int wmo_read_bufr_from_file(FILE* f,void* buffer,size_t* len);
GRIBAPI_API int wmo_read_gts_from_file(FILE* f,void* buffer,size_t* len);
GRIBAPI_API int wmo_read_any_from_stream(void *stream_data, long (*stream_proc )(void *, void *buffer, long len ), void *buffer, size_t *len);
GRIBAPI_API void *wmo_read_any_from_file_malloc(FILE *f,size_t *size,int *err);
GRIBAPI_API void *wmo_read_gts_from_file_malloc(FILE* f,size_t *size,int* err);
GRIBAPI_API void *wmo_read_bufr_from_file_malloc(FILE* f,size_t *size,int* err);
GRIBAPI_API grib_handle* grib_gts_handle_new_from_file ( grib_context* c, FILE* f,int *error );
GRIBAPI_API grib_handle* grib_bufr_handle_new_from_file ( grib_context* c, FILE* f,int *error );
...
GRIBAPI_API grib_box* grib_box_new(grib_handle* h,int* error);
GRIBAPI_API grib_points* grib_box_get_points(grib_box *box,double north, double west,double south,double east, int *err);
GRIBAPI_API int grib_points_get_values(grib_handle* h, grib_points* points, double* val);
