...
//! generated by the methods Params::captureSetLong(), Params::CaptureSetDouble(), Params::CaptureSetString(),
//! so is it only necessary to directly use CaptureStart and CaptureEnd when more than one state change occurs
