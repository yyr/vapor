...
bool Box::cropToBox(const double bxExts[6], Params*p){
...
bool Box::fitToBox(const double boxExts[6], Params* p){
	...
	SetLocalExtents(exts,p);
	bool success = cropToBox(boxExts,p);
	//bool success = true;
	return success;
}
...
void Box::rotateAndRenormalize(int axis, double rotVal, Params* p){
