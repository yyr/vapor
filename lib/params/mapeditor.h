...
//		Also define MapEditorCollection, a class that holds a MapEditor
//		for each DvrParams and for each variable in the current metadata
//
#ifndef MAPEDITOR_H
#define MAPEDITOR_H
...
public:
	...
	//Paint the editor on the frame..
	virtual void refreshImage(QImage* editImage, Histo* h = 0) = 0;
