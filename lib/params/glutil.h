...
PARAMS_API void imagQuat2View(float q[3], float vdir[3],float upvec[3], bool backside = false);
PARAMS_API bool view2ImagQuats(float vdir1[3],float upvec1[3],float vdir2[3],float upvec2[3], float q1[3],float q2[3]);
