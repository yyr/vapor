...
#line 352 "parser.y"
    {
		    ...
		    if (stricmp((yyvsp[(3) - (3)].id), "UTC") != 0 &&
			    stricmp((yyvsp[(3) - (3)].id), "GMT") != 0 &&
			    stricmp((yyvsp[(3) - (3)].id), "Z") != 0) {
			ut_set_status(UT_UNKNOWN);
			error = 1;
		    }
...
#line 390 "parser.y"
    {
		    ...
		    if (stricmp((yyvsp[(2) - (2)].id), "UTC") != 0 &&
			    stricmp((yyvsp[(2) - (2)].id), "GMT") != 0 &&
			    stricmp((yyvsp[(2) - (2)].id), "Z") != 0) {
			ut_set_status(UT_UNKNOWN);
			error = 1;
		    }
