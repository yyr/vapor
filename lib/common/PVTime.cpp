...
struct tm *VetsUtil::GmTime64_r (const TIME64_T *_t, struct tm *p)
{
    TIME64_T t;
    t = *_t;
...
TIME64_T VetsUtil::MkTime64 (struct tm *t)
{
    int i, y;
    long day = 0;
    TIME64_T r;
...
struct tm *VetsUtil::LocalTime64_r (const TIME64_T *_t, struct tm *p)
{
    TIME64_T tl;
    tl = *_t;
