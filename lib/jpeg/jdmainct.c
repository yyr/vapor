			   ...
			   JDIMENSION out_rows_avail)
{
  ...
  case CTX_PREPARE_FOR_IMCU:
    ...
    my_main->rowgroup_ctr = 0;
    my_main->rowgroups_avail = (JDIMENSION) (cinfo->min_DCT_scaled_size - 1);
  ...
  case CTX_PROCESS_IMCU:
    ...
    my_main->rowgroup_ctr = (JDIMENSION) (cinfo->min_DCT_scaled_size + 1);
    my_main->rowgroups_avail = (JDIMENSION) (cinfo->min_DCT_scaled_size + 2);
